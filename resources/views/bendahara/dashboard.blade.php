...
@section('content')
<h2 class="text-xl font-bold mb-4">Dashboard Bendahara</h2>
<p>Selamat datang, {{ auth()->user()->name }} (Bendahara)</p>

<h3 class="text-lg font-semibold mt-6">Riwayat Transaksi Kelas</h3>
